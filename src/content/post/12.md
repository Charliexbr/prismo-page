...
║ 密钥管理                                                       ║
║ • 生成私钥: wg genkey                                         ║
║ • 提取公钥: wg pubkey < private.key                           ║
║ • 生成PSK: wg genpsk                                          ║
╠═══════════════════════════════════════════════════════════════╣
║ 故障诊断                                                       ║
║ • 检查服务: systemctl status wg-quick@wg0                     ║
║ • 查看日志: journalctl -u wg-quick@wg0 -f                     ║
║ • 测试连接: ping 10.8.0.1                                     ║
║ • 检查端口: ss -ulnp | grep 51820                             ║
╠═══════════════════════════════════════════════════════════════╣
║ 配置要点                                                       ║
║ • 服务器: Address = 10.8.0.1/24                               ║
║ • 客户端: Address = 10.8.0.2/24                               ║
║ • 端口: ListenPort = 51820                                    ║
║ • MTU: MTU = 1420                                             ║
